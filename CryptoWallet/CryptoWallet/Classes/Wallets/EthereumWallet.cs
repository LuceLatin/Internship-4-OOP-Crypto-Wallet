...
{
    public class EthereumWallet : Wallets, INonFungibleWallet
    {
        ...
        public decimal NonFungibleTotalValueOfAllAssetsInUSD(List<Asset> listOfAssets)
        {
        ...
        {
            Console.WriteLine($"Type of wallet: Ethereum.\n"
                + $"Address of wallet: {Address}\n " +
                 $"Total value of all assets that it own is: {NonFungibleTotalValueOfAllAssetsInUSD(listOfAssets)} (USD) \n" +
                $"");
            //interfaces
